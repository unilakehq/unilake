...
namespace Unilake.WebApp.Shared.Components.Tooltips.Internal;

/// <summary>
/// Common implementation for <see cref="DTooltip"/> and <see cref="DPopover"/>.
/// </summary>
/// <remarks>
/// We do not want DPopover to derive from DTooltip directly as we want
/// to keep the API consistent, e.g. HxPopover.Placement = PopoverPlacement.Auto, not TooltipPlacement.Auto or anything else.
/// </remarks>
public abstract class DTooltipInternalBase : ComponentBase, IAsyncDisposable
{
	...
	private DotNetObjectReference<DTooltipInternalBase> dotnetObjectReference;
	...
	protected DTooltipInternalBase()
	{
