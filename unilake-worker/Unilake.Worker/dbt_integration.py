# Copyright (c) 2020 innover.io https://github.com/innoverio/vscode-dbt-power-user/blob/master/dbt_integration.py
...
class DbtProject:
    ...
    def from_args(cls, args: ConfigInterface) -> "DbtProject":
        """Instantiate the DbtProject directly from a ConfigInterface instance"""
        return cls(
            target=args.target,
    ...
    def clear_caches(self) -> None:
        """Clear least recently used caches and re-instantiable container objects"""
